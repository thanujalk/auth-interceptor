...
import org.wso2.carbon.security.interceptor.annotation.Secure;
...
public class AuthInterceptor implements Interceptor {
    ...
    public boolean preCall(HttpRequest httpRequest, HttpResponder httpResponder, ServiceMethodInfo serviceMethodInfo) {
        ...
        //TODO: Authorization also handled in this interceptor since we can't decide order of execution for interceptors
